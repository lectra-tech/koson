...
image:https://travis-ci.org/lectra-tech/koson.svg?branch=master["koson build", link="https://travis-ci.org/lectra-tech/koson"] image:https://maven-badges.herokuapp.com/maven-central/com.lectra/koson/badge.svg["maven central", link="https://maven-badges.herokuapp.com/maven-central/com.lectra/koson"]
...
Available on https://search.maven.org/search?q=g:com.lectra%20AND%20a:koson[Maven Central]
