...
In general if you know what to render, you should favor using DSL elements to build your Json.

If you want to include an external source of Json you can use the `rawJson(validJson: String?)` function.
