image:https://github.com/ncomet/koson/blob/master/image/koson-logo.png["Koson Logo"]
...
.In IntelliJ, compilation errors will show up, and code will be flagged as not reachable
