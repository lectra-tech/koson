...
image:https://travis-ci.org/lectra-tech/koson.svg?branch=master["koson build", link="https://travis-ci.org/lectra-tech/koson", window=_blank] image:https://img.shields.io/maven-central/v/com.lectra/koson.svg["Maven Central", link="https://search.maven.org/search?q=g:com.lectra%20AND%20a:koson", window=_blank]
...
Available on https://search.maven.org/search?q=g:com.lectra%20AND%20a:koson[Maven Central, window=_blank]
